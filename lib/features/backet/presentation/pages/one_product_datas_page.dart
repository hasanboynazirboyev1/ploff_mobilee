                ...
                SliverAppBar(
                    leading: IconButton(
                        ...
                        icon: SvgPicture.asset(
                            'assets/svg_icons/order_icons/ic_back.svg')),
                    actions: [
                      SvgPicture.asset(
                          'assets/svg_icons/order_icons/ic_connect.svg'),
                    ],
                          ...
                          child: Container(
                            decoration: const BoxDecoration(
                                image: DecorationImage(
                                    fit: BoxFit.cover,
                                    image: AssetImage("assets/home_/123.jpg"))),
                          ),
                        ),
                        Positioned(
                          bottom: 0,
            ...
            bottomSheet: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Padding(
                          padding:
                              EdgeInsets.only(left: 12, bottom: 23, top: 16),
                          child: Text(
                            'Размер*',
                            style: TextStyle(
