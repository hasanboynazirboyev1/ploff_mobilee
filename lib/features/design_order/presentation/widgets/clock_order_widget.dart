...
class ClockOrderWidget extends StatelessWidget {
  const ClockOrderWidget({super.key});
              ...
              children: [
                ...
                ListView.separated(
                  ...
                  itemBuilder: ((context, index) {
                    return ListTile(
                      onTap: () {
                        designOrderBloc.add(CheckBoxClockEvent(index));
                      },
                      leading: SvgPicture.asset(state.imagePathClock[index]),
                      title: Text(
                        index == 0
                            ? 'Срочная доставка'
                      ...
                      trailing: SvgPicture.asset(state.checkClock![index]
